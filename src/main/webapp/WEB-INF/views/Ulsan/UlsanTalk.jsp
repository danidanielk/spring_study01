			...
			<div class="panel-body">
				<form class="form-horizontal" action="UlsanTalk.do" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<!--  form-control 한줄 채워줌 -->
							<textarea class="form-control" rows="10" cols="" name="t_content"></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="t_id" value="${loginMember.id }"
							placeholder="Enter writer" readonly>
							<input type="text" class="form-control" name="t_name" value="${loginMember.name }"
							placeholder="Enter writer" readonly>
							<!-- 
					...
					<div class="form-group">
						<div class="col-sm-offset-2 col-sm-10">
							...
							<button type="reset" class="brn btn-warning btn-sm"onclick="location.href='talk.do'">취소</button>
						</div>
					</div>
				</form>
			</div>
